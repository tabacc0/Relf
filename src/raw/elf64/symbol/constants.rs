...
* the higher 4 bits of st_info hold ELF64_ST_BIND
* the lower 4 bits of st_info hold ELF64_ST_TYPE
* see below for definition and interpretation of values these can hold
* */

/*values of ELF64_ST_BIND and their interpretation
...
/*values of ELF64_ST_TYPE and their interpretation
keep in mind each of these is in practice 4 bits long
using u8 here for convenience:
*/
...
//
//values for ELF64_ST_VISIBILITY and their significance :
//the visibility as indicated by ELF64_ST_BIND
