...
pub const ELF64SHDRSIZE: usize = 64;

//values of sh_type and their signification
//
//marks the header as inactive , no associated section
pub const SHT_NULL: Elf64Word = Elf64Word { value: 0 };
//the corresponding section is custom and used by the program
pub const SHT_PROGBITS: Elf64Word = Elf64Word { value: 1 };
//the section is a SYMBOL table
pub const SHT_SYMTAB: Elf64Word = Elf64Word { value: 2 };
//the section is a STRING table
pub const SHT_STRTAB: Elf64Word = Elf64Word { value: 3 };
//section has relocation entries with addends
pub const SHT_RELA: Elf64Word = Elf64Word { value: 4 };
//section is a symbol hash table
pub const SHT_HASH: Elf64Word = Elf64Word { value: 5 };
//section has information for dynamic linkning
pub const SHT_DYNAMIC: Elf64Word = Elf64Word { value: 6 };
//section holds data that marks the file
pub const SHT_NOTE: Elf64Word = Elf64Word { value: 7 };
//section occupies no space sh_size=0
pub const SHT_NOBITS: Elf64Word = Elf64Word { value: 8 };
//section has relocation entries without addends
pub const SHT_REL: Elf64Word = Elf64Word { value: 9 };
//this one is reseved but no meaning yet
pub const SHT_SHLIB: Elf64Word = Elf64Word { value: 10 };
//section is a SYMBOL table
pub const SHT_DYNSYM: Elf64Word = Elf64Word { value: 11 };
...
pub const SHT_INIT_ARRAY: Elf64Word = Elf64Word { value: 14 };
//array of pointers to termination functions
//executed generally AFTER the main program
//they are parameterless and return void
pub const SHT_FINI_ARRAY: Elf64Word = Elf64Word { value: 15 };
//array of pointers to functions that are executed before init funcs
//they are parameterless and return void
pub const SHT_PREINIT_ARRAY: Elf64Word = Elf64Word { value: 16 };
...
pub const SHT_GROUP: Elf64Word = Elf64Word { value: 17 };
//this section is an array of Elf64Word values,
...
pub const SHT_SYMTAB_SHNDX: Elf64Word = Elf64Word { value: 18 };

pub const VALID_SHT: &[Elf64Word] = &[
    SHT_NULL,
    SHT_PROGBITS,
    SHT_SYMTAB,
    SHT_DYNSYM,
...
pub const SHT_LOOS: Elf64Word = Elf64Word { value: 0x60000000 };
pub const SHT_HIOS: Elf64Word = Elf64Word { value: 0x6fffffff };
//these two specify a range reserved for processor specific semantics
pub const SHT_LOPROC: Elf64Word = Elf64Word { value: 0x70000000 };
pub const SHT_HIPROC: Elf64Word = Elf64Word { value: 0x7fffffff };
//these two specify a range reserved for applications to use
pub const SHT_LOUSER: Elf64Word = Elf64Word { value: 0x80000000 };
pub const SHT_HIUSER: Elf64Word = Elf64Word { value: 0xffffffff };

//values for sh_flag and their signification
//
//section has data that should be writable during execution
pub const SHF_WRITE: Elf64Xword = Elf64Xword { value: 1 }; //0b1
//section occupies memory during execution, off for control sections
pub const SHF_ALLOC: Elf64Xword = Elf64Xword { value: 2 }; //0b10
//section has executable machine instructions
pub const SHF_EXECINSTR: Elf64Xword = Elf64Xword { value: 4 }; //0b100
...
pub const SHF_MERGE: Elf64Xword = Elf64Xword { value: 0x10 };
//this section holds null terminated strings
pub const SHF_STRINGS: Elf64Xword = Elf64Xword { value: 0x20 };
//the sh_info of this section header hold an index into the
//section header index
pub const SHF_INFO_LINK: Elf64Xword = Elf64Xword { value: 0x40 };
...
//with.
pub const SHF_LINK_ORDER: Elf64Xword = Elf64Xword { value: 0x80 };
//this section requires OS-specific processing for correct behavior
pub const SHF_OS_NONCONFORMING: Elf64Xword = Elf64Xword { value: 0x100 };
...
//group sections are arrays of Elf64Xword , the first entry (index 0)
...
pub const SHF_GROUP: Elf64Xword = Elf64Xword { value: 0x200 };
//this section holds thread local storage,
//each thread has its own data in this section
pub const SHF_TLS: Elf64Xword = Elf64Xword { value: 0x400 };
//all bits reserved for operating system specific flags
pub const SHF_MASKOS: Elf64Xword = Elf64Xword { value: 0x0ff00000 };
//all bits reserved for processor specific flags
pub const SHF_MASKPROC: Elf64Xword = Elf64Xword { value: 0xf0000000 };

//significance of bits in the flag Word of group section
// this group is a COMDAT group
pub const GRP_COMDAT: Elf64Word = Elf64Word { value: 0x1 };
//bits reserved for os-specific semantics
pub const GRP_MASKOS: Elf64Word = Elf64Word { value: 0x0ff00000 };
//bits reserved for cpu-specific semantics
pub const GRP_MASKPROC: Elf64Word = Elf64Word { value: 0xf0000000 };
